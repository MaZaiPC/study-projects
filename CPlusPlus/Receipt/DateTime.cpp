...
// «апись даты в файл в двоичном формате. ≈сли не все данные
// записаны, то возвращаетс€ 1, если все записано, то возвращаетс€ 0
...
// „тение даты из файла в двоичном формате, если не все данные
// прочитаныны, то возвращаетс€ 1, если все прочитано, то возвращаетс€ 0
