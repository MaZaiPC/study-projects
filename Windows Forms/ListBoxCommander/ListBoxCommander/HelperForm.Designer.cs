namespace MaZaiPC.ListBoxCommander
{
	partial class HelperForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.tabPage4.Size = new System.Drawing.Size(608, 390);
			this.tabPage4.TabIndex = 3;
			this.tabPage4.Text = "Профит";
			...
			this.label7.Size = new System.Drawing.Size(544, 80);
			this.label7.TabIndex = 8;
			this.label7.Text = "Если Вы сделали всё правильно, то в указанный список будет добавлена Ваша строка." +
    "";
			...
			this.tabPage3.Size = new System.Drawing.Size(608, 390);
			...
			this.label5.Size = new System.Drawing.Size(208, 208);
			this.label5.TabIndex = 5;
			this.label5.Text = "Чтобы записать строку в выбранный лист, нажмите на кнопку \"Запись строки\".\r\n\r\nНюа" +
    "нс:\r\nДля быстрого добавления в выбранный список Вы можете нажать ENTER сразу пос" +
    "ле ввода желаемой строки.";
			// 
			// label6
			// 
			...
			this.tabPage2.Size = new System.Drawing.Size(608, 390);
			...
			this.label4.Size = new System.Drawing.Size(208, 208);
			this.label4.TabIndex = 2;
			this.label4.Text = "Для начала работы со списком кликните по нему ЛКМ, либо выберите имеющийся в нем " +
    "элемент.";
			// 
			// label3
			// 
			...
			this.tabPage1.Size = new System.Drawing.Size(608, 390);
			...
			this.label2.Size = new System.Drawing.Size(208, 208);
			this.label2.TabIndex = 2;
			this.label2.Text = "Введите текст, который желаете добавить в один из списков.";
			// 
			// label1
			// 
			...
			this.tabControl1.Size = new System.Drawing.Size(616, 416);
